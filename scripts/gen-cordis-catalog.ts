...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  deploymentInventory: 'deployment.md',
  executionWorldRouter: 'deployment.md',
  gitWorktrees: 'deployment.md',
  ssh: 'ssh.md',
  agentLoop: 'core.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  CreateGitWorktree: 'deployment.md',
  GitWorktree: 'deployment.md',
  AccessAuditFields: 'access-control.md',
  AccessActor: 'access-control.md',
  AccessPermission: 'access-control.md',
  AccessRole: 'access-control.md',
  AccessUserView: 'access-control.md',
  AccessAuditEntry: 'access-control.md',
  DeploymentTarget: 'deployment.md',
  DeploymentTargetGrant: 'deployment.md',
  DeploymentTargetGrantSet: 'deployment.md',
  DeploymentPlan: 'deployment.md',
  DeploymentPlanCreate: 'deployment.md',
  DeploymentPlanId: 'deployment.md',
  DeploymentRollout: 'deployment.md',
  DeploymentRolloutCreate: 'deployment.md',
  DeploymentRolloutId: 'deployment.md',
  DeploymentRolloutPhase: 'deployment.md',
  DeploymentRolloutStep: 'deployment.md',
  DeploymentRolloutStatus: 'deployment.md',
  DeploymentRolloutTarget: 'deployment.md',
  DeploymentRolloutTargetStatus: 'deployment.md',
  DeploymentTargetCreate: 'deployment.md',
  DeploymentTargetHealth: 'deployment.md',
  DeploymentTargetId: 'deployment.md',
  DeploymentTargetUpdate: 'deployment.md',
  DeploymentWorktree: 'deployment.md',
  DeploymentWorktreeCreate: 'deployment.md',
  ExecutionTargetId: 'deployment.md',
  ExecutionWorldRoute: 'deployment.md',
  ExecutionWorldRouteProvider: 'deployment.md',
  SshChannel: 'ssh.md',
  SshChannelOptions: 'ssh.md',
  SshCommandOptions: 'ssh.md',
  SshCommandResult: 'ssh.md',
  UserIdBrand: 'access-control.md',
  Agent: 'core.md',
